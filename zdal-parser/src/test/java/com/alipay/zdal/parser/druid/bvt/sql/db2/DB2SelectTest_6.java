...
public class DB2SelectTest_6 {

    @Test
    public void test_0() throws Exception {
        String sql = "select * from (select id,rownumber() over(order by id asc) as rownum  from test where id = ?) a where a.rownum >= ? AND a.rownum < ? and a.name=? ";
        ...
        //        System.out.println(PagerUtils.limit(sql, JdbcUtils.DB2, 10, 20));
