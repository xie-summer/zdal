...
public class DB2SelectTest_0 {

    @Test
    public void test_0() throws Exception {
        String sql = "SELECT * FROM DSN81010.EMP where id = ? and name ='test';";
        ...
        System.out.println("bindVarConditions :" + visitor.getBindVarConditions());
        System.out.println("noBindVarConditions :" + visitor.getNoBindVarConditions());
