...
public class VetoableChangeMulticaster implements Serializable {
    ...
    protected void multicast(PropertyChangeEvent evt) throws PropertyVetoException {
        ...
        try {
            ...
            PropertyChangeEvent revert = new PropertyChangeEvent(evt.getSource(), evt
                .getPropertyName(), evt.getNewValue(), evt.getOldValue());
    ...
    public void fireVetoableChange(String propertyName, int oldValue, int newValue)
        ...
        if (oldValue != newValue) {
            multicast(new PropertyChangeEvent(source, propertyName, new Integer(oldValue),
    ...
    public void fireVetoableChange(String propertyName, boolean oldValue, boolean newValue)
                                                                                           throws PropertyVetoException {
        if (oldValue != newValue) {
            multicast(new PropertyChangeEvent(source, propertyName, new Boolean(oldValue),
